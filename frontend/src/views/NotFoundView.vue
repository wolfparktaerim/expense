<template>
    ...
    style="background-image: url('https://plus.unsplash.com/premium_vector-1689096934387-7c844f44a153?q=80&w=1460&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')">
    <div class="max-w-md mx-auto text-center bg-white bg-opacity-90 p-8 rounded-lg shadow-lg">
        <div class="text-9xl font-bold text-purple-600 mb-4">404</div>
        ...
        <a href="/"
        class="inline-block bg-purple-600 text-white font-semibold px-6 py-3 rounded-md hover:bg-indigo-700 transition-colors duration-300">
        Go Back Home
        </a>
    </div>
    </div>
